 ...
 */
@RestController
@RequestMapping("/utenteEsperienza")
@CrossOrigin(origins = "http://localhost:4200")
public class UtenteEsperienzaController extends AbstractController<UtenteEsperienzaDTO>{
	
	
	@Autowired
	private UtenteEsperienzaService utenteEsperienzaService;
